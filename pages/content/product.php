    ...
    <div class="detail" style="display: flex; flex-direction: row; align-items: flex-start; max-width: 100%;">
        ...
        <form method="POST" action="#">
            <div class="product-detail" style="max-width: 60%; font-family: 'Arial', sans-serif;">
                ...
                <p><input class="addtocart" type="submit" value="Thêm vào gỏ hàng" style="background-color: #e74c3c; color: white; border: none; padding: 12px 20px; font-size: 1em; cursor: pointer; transition: background-color 0.3s ease; border-radius: 5px;"></p>
            </div>
        </form>
    </div>
<?php
